    ...
    const item = (todo, project, nthProject, nthItem) => {
        ...
        todoInfoButton.addEventListener('click', () => {
            ...
            document.querySelector('.infoPopup').style.display = "block";
                ...
                dueDateInfo.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(todo.dueDate.replace(/-/g, '/')),'MMMM dd, yyyy');
...
if (localStorage.getItem('projectList')){
    ...
    _DOM_js__WEBPACK_IMPORTED_MODULE_0__.createDOM.projectInit(projectList);
...
itemEditSubmit.addEventListener('click', (e) => {
    ...
    project[currentProject][_DOM_js__WEBPACK_IMPORTED_MODULE_0__.currentItem].dueDate = document.querySelector('.dueDateEdit').value
    project[currentProject][_DOM_js__WEBPACK_IMPORTED_MODULE_0__.currentItem].priority = document.querySelector('.priorityEdit').value
    // clear the main panel
    while(todoList.firstChild){todoList.firstChild.remove()};    
