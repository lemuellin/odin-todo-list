...
itemSubmit.addEventListener('click', e => {
  ...
  const todo = todoItem(document.querySelector('.title').value, document.querySelector('.description').value, currentProject, 'incomplete', document.querySelector('.dueDate').value, document.querySelector('.priority').value);
